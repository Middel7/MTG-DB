#!/usr/bin/env python3
"""Import du Price Guide Cardmarket (Magic)."""
...
from mtgdb.cardmarket import PRICE_GUIDE_URL
...
def main() -> None:
    ...
    with httpx.Client(timeout=httpx.Timeout(30.0, read=300.0)) as client:
        with SessionLocal() as session:
            log.info("Téléchargement du Price Guide Cardmarket…")
            file_path, import_row = download_file(
                client, session, PRICE_GUIDE_URL, "price_guide_magic", RAW_DIR
            )
